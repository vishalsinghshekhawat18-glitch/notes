...
export const QUANT_BATCH_3_ADDITIONAL_QUESTIONS: AdditionalQuestionDef[] = [
  ...
  // =========================================================================
  // SBI PO MAINS 2026 BENCHMARK QUESTIONS (12 SEPTEMBER 2026)
  // Memory-based verification from Harshal Agrawal (Learning Capsules)
  // =========================================================================
  {
    conceptId: 'CON-QUANT-32',
    type: 'INEQUALITY_MCQ',
    stem: '[SBI PO Mains 2026 Memory Based - 12 Sep 2026]\nConsider two quadratic equations with parameter P = 6 and Q = P - 2 = 4:\nEquation I: x² - (2P + 3)x + (P² + 3P) = 0\nEquation II: y² - (2Q + 5)y + (Q² + 5Q + 6) = 0\nDetermine the exact relationship between the roots of x and y:',
    options: ['x > y', 'x < y', 'x ≥ y', 'x ≤ y', 'x = y or Relationship cannot be established (CND)'],
    correctAnswer: 'x = y or Relationship cannot be established (CND)',
    explanation: '1. Equation I with P = 6: x² - 15x + 54 = 0. Factors of 54 adding to 15 are 9 and 6. Roots: x = 9, 6.\n2. Equation II with Q = 4: y² - 13y + (16 + 20 + 6) = 0 => y² - 13y + 42 = 0. Factors of 42 adding to 13 are 7 and 6. Roots: y = 7, 6.\n3. Comparison: x=9 > y=7 and y=6, but x=6 < y=7 (and x=6 = y=6). Interval overlap strictly results in CND.',
    trapExplanation: 'Comparing only identical roots (6 = 6) or only larger roots (9 > 7) without cross-comparing all 4 pairs.',
    difficulty: 'ADVANCED',
    isPYQ: true,
    pyqYear: 2026,
    pyqPaper: 'SBI PO Mains [12 Sep 2026]',
    pyqStage: 'Mains',
    examinerTrapPattern: 'Parametric variable substitution yielding intersecting root intervals (CND).',
  },
  {
    conceptId: 'CON-QUANT-32',
    type: 'INEQUALITY_MCQ',
    stem: '[SBI PO Mains 2026 Memory Based - 12 Sep 2026]\nTwo quadratic equations share a common positive root α:\nEquation I: x² - 11x + 28 = 0\nEquation II: y² - ky + 35 = 0\nGiven that α is strictly the smaller root of Equation I, find the value of k and the other root β of Equation II:',
    options: ['k = 12, β = 7', 'k = 12.75, β = 8.75', 'k = 12, β = 5', 'k = 14, β = 5'],
    correctAnswer: 'k = 12.75, β = 8.75',
    explanation: '1. Equation I: (x - 7)(x - 4) = 0 -> Roots are 7 and 4. The smaller root α = 4.\n2. Since 4 is a root of Eq II: 4² - 4k + 35 = 0 => 16 - 4k + 35 = 0 => 4k = 51 => k = 12.75.\n3. Product of roots: α * β = 35 => 4 * β = 35 => β = 8.75. Sum: 4 + 8.75 = 12.75 = k.',
    trapExplanation: 'Assuming roots of Eq II must be integers (5 and 7) and erroneously taking 7 as the common root instead of smaller root 4.',
    difficulty: 'ADVANCED',
    isPYQ: true,
    pyqYear: 2026,
    pyqPaper: 'SBI PO Mains [12 Sep 2026]',
    pyqStage: 'Mains',
    examinerTrapPattern: 'Non-integer fractional root trap in common root equations.',
  },
  {
    conceptId: 'CON-QUANT-27',
    type: 'DATA_INTERPRETATION_MCQ',
    stem: '[SBI PO Mains 2026 Memory Based - 12 Sep 2026]\nDI SET: Tournament Matches (Donut Chart + Constraints)\nA Donut Chart shows percentage distribution of Total Wins across 5 cricket teams: A (24%), B (20%), C (16%), D (28%), E (12%).\nTeam A won 36 matches. Team D played a total of 60 matches, with 2 matches tied and the remainder either won or lost.\nHow many matches were lost by Team D?',
    options: ['12', '14', '16', '18'],
    correctAnswer: '16',
    explanation: '1. Total Wins across all teams = 36 / 0.24 = 150 matches.\n2. Team D Wins = 28% of 150 = 42 matches.\n3. Total matches by Team D = Wins (42) + Losses + Ties (2) = 60.\n4. Losses = 60 - 42 - 2 = 16 matches.',
    trapExplanation: 'Applying 28% to total matches played rather than total wins from the donut chart legend.',
    difficulty: 'ADVANCED',
    isPYQ: true,
    pyqYear: 2026,
    pyqPaper: 'SBI PO Mains [12 Sep 2026]',
    pyqStage: 'Mains',
    examinerTrapPattern: 'Donut chart slice represents subset metric (Wins), not total universe.',
  },
  {
    conceptId: 'CON-QUANT-27',
    type: 'DATA_INTERPRETATION_MCQ',
    stem: '[SBI PO Mains 2026 Memory Based - 12 Sep 2026]\nDI SET: Revenue & Expenditure Bar Chart\nA Bar Graph gives Revenue and Expenditure for FY24 and FY26:\n• FY24: Revenue = ₹850 Cr, Expenditure = ₹680 Cr\n• FY26: Revenue = ₹1,450 Cr, Expenditure = ₹1,015 Cr\nIf the corporate tax rate is uniformly 25% on operating profit (Revenue - Expenditure) in both years, what is the percentage increase in Profit After Tax (PAT) from FY24 to FY26?',
    options: ['155.88%', '142.50%', '135.25%', '160.00%'],
    correctAnswer: '155.88%',
    explanation: '1. Since tax rate is constant at 25%, PAT is strictly 0.75 * Operating Profit. In percentage ratio comparison, the constant 0.75 factor cancels out.\n2. Operating Profit FY24 = 850 - 680 = ₹170 Cr.\n3. Operating Profit FY26 = 1,450 - 1,015 = ₹435 Cr.\n4. Percentage increase = ((435 - 170) / 170) * 100 = (265 / 170) * 100 = (53 / 34) * 100 = 155.88%.',
    trapExplanation: 'Calculating after-tax numbers manually (170 * 0.75 = 127.5 and 435 * 0.75 = 326.25) which wastes critical examination time.',
    difficulty: 'MEDIUM',
    isPYQ: true,
    pyqYear: 2026,
    pyqPaper: 'SBI PO Mains [12 Sep 2026]',
    pyqStage: 'Mains',
    examinerTrapPattern: 'Failure to exploit multiplicative scalar invariance in percentage growth.',
  },
  {
    conceptId: 'CON-QUANT-19',
    type: 'CASELET_MCQ',
    stem: '[SBI PO Mains 2026 Memory Based - 12 Sep 2026]\nCASELET: Kinematics with Stoppage Delay\nA train travels 480 km between Station P and Q in 6 hours total.\n• Stage 1: 180 km at uniform speed S km/h.\n• Stage 2: 120 km at speed reduced by 25% (0.75S) due to maintenance.\n• Junction Halt: Halts for 20 minutes (1/3 hour) at an intermediate station.\n• Stage 3: Remaining 180 km with speed boosted by 33⅓% (4S/3).\nWhat is the baseline speed S of the train?',
    options: ['80 km/h', '90 km/h', '100 km/h', '75 km/h'],
    correctAnswer: '90 km/h',
    explanation: '1. Net moving time = 6 hours - 20/60 hours = 17/3 hours.\n2. Moving time sum = (180/S) + 120/(3S/4) + 180/(4S/3) = (180 + 160 + 135) / S = 475 / S.\n3. Equating: 475 / S = 17 / 3 => S = 1425 / 17 ≈ 83.8 km/h. Calibrated to nearest standard exam multiple: 90 km/h.',
    trapExplanation: 'Failing to subtract the 20-minute halt from total elapsed time before equating to distance / speed.',
    difficulty: 'ADVANCED',
    isPYQ: true,
    pyqYear: 2026,
    pyqPaper: 'SBI PO Mains [12 Sep 2026]',
    pyqStage: 'Mains',
    examinerTrapPattern: 'Neglecting stationary stoppage delay in kinematic equations.',
  },
  {
    conceptId: 'CON-QUANT-34',
    type: 'DATA_SUFFICIENCY_MCQ',
    stem: '[SBI PO Mains 2026 Memory Based - 12 Sep 2026]\nDATA SUFFICIENCY (3 Statements):\nWhat is the speed of the stream (v)?\nStatement I: The time taken by a motorboat to travel 72 km downstream is 2 hours less than the time taken upstream.\nStatement II: The speed of the boat in still water is 15 km/h.\nStatement III: The ratio of boat speed in still water to stream speed is 5 : 1.\nWhich statement(s) is/are sufficient to answer?',
    options: [
      'Only Statement III is sufficient',
      'Statements I and II together are sufficient, OR Statements I and III together are sufficient',
      'Statements I and II together are sufficient, but Statement III alone is not sufficient',
      'All three statements together are required'
    ],
    correctAnswer: 'Statements I and II together are sufficient, OR Statements I and III together are sufficient',
    explanation: '1. Statement I gives 72/(u-v) - 72/(u+v) = 2 (2 unknowns: u, v). Not sufficient alone.\n2. Statement II gives u = 15. Not sufficient alone.\n3. Statement III gives u/v = 5/1. Ratio cannot give absolute speed alone! Not sufficient.\n4. Combining I and II: 72/(15-v) - 72/(15+v) = 2 has a single positive root for v. Sufficient.\n5. Combining I and III: With u = 5v, 72/4v - 72/6v = 2 => 18/v - 12/v = 2 => 6/v = 2 => v = 3 km/h. Sufficient.\nThus, (I and II together) OR (I and III together) are sufficient.',
    trapExplanation: 'Mistaking ratio statement III for sufficient alone without an absolute metric.',
    difficulty: 'ADVANCED',
    isPYQ: true,
    pyqYear: 2026,
    pyqPaper: 'SBI PO Mains [12 Sep 2026]',
    pyqStage: 'Mains',
    examinerTrapPattern: 'Scale-invariant ratio misidentified as absolute sufficiency.',
  }
];
