...
* ⚠️ **Trap 2: Tax Shift Direction:** Imposition of a GST or per-unit excise tax shifts the **Supply Curve vertically upward (leftward)** by the exact amount of the tax.`,
    ...
    questions: [
      ...
      {
        type: 'CONCEPT_CHECK',
        stem: 'If the prevailing market price of a commodity is set above its equilibrium price ($P > P^*$), what disequilibrium condition occurs and through what mechanism is market equilibrium restored in a free, competitive market?',
        options: [
          'A shortage ($Q_D > Q_S$) emerges, prompting impatient buyers to bid up prices until $Q_D = Q_S$.',
          'A surplus ($Q_S > Q_D$) emerges, causing unsold inventories to accumulate and inducing sellers to cut prices until $Q_D = Q_S$.',
          'A surplus emerges, causing the market supply curve to shift immediately to the left to match consumer demand.',
          'A shortage emerges, prompting the government to mandate price floors to clear accumulated backorders.',
        ],
        correctAnswer: 'A surplus ($Q_S > Q_D$) emerges, causing unsold inventories to accumulate and inducing sellers to cut prices until $Q_D = Q_S$.',
        explanation: 'When price is higher than equilibrium ($P > P^*$), the higher price simultaneously expands quantity supplied along the supply curve and contracts quantity demanded along the demand curve, creating excess supply or a surplus ($Q_S > Q_D$). In an unregulated competitive market, firms observe unwanted inventory accumulation and engage in downward price competition. As price falls, buyers expand quantity demanded and sellers contract quantity supplied until the market-clearing equilibrium is re-established where $Q_D = Q_S$.',
        trapExplanation: 'Option C is a classic conceptual confusion trap: disequilibrium prices cause movements along existing curves (changes in quantity demanded and supplied), not a shift of the supply curve.',
        difficulty: 'EASY',
        isPYQ: false,
        examinerTrapPattern: 'Confusing price-induced self-correcting movements along curves with curve shifts during market disequilibrium.',
      },
    ],
  },
  {
